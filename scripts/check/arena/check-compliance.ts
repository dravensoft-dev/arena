...
export const COVERED = {
  ...
  'ArenaKeyValue:react': 'InertComponents.dom.test.tsx',
  'ArenaAppBar:react': 'PageLandmarks.dom.test.tsx',
  'ArenaSiteFooter:react': 'PageLandmarks.dom.test.tsx',
  'ArenaMain:react': 'PageLandmarks.dom.test.tsx',
  ...
  'ArenaKeyValue:angular': 'ArenaKeyValue.compliance.test.ts',
  'ArenaAppBar:angular': 'ArenaAppBar.compliance.test.ts',
  'ArenaSiteFooter:angular': 'ArenaSiteFooter.compliance.test.ts',
  'ArenaMain:angular': 'ArenaMain.compliance.test.ts',
