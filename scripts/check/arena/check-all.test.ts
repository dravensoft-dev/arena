...
test('GATES lists every check gate', () => {
  assert.equal(GATES.length, 73);
  assert.deepEqual(
    GATES.map((g) => g.name),
    ['check:docs', 'check:graph', 'check:portability', 'check:generated', 'check:skill-spec', 'check:skills', 'check:prompts', 'check:routes', 'check:vocabulary', 'check:architecture', 'check:duplication', 'check:dtcg', 'check:catalogue', 'check:style-plugin', 'check:style-plugin-coverage', 'check:role-contract', 'check:compat-aliases', 'check:polarity', 'check:tokens', 'check:token-collisions', 'check:script-tokens', 'check:duplicate-constants', 'check:deadlines', 'check:ramp', 'check:boundary-contrast', 'check:text-contrast', 'check:tailwind', 'check:tailwind-generated', 'check:coverage', 'check:radius', 'check:roles', 'check:arbitrary', 'check:component-css', 'check:dimensions', 'check:states', 'check:appearance', 'check:parts', 'check:layer-independence', 'check:structure', 'check:contracts', 'check:behaviour', 'check:compliance', 'check:api', 'check:playgrounds', 'check:kitchen-sink', 'check:citations', 'check:agents', 'check:agents-spec', 'check:community', 'check:site', 'check:icons', 'check:fonts', 'check:intro', 'check:vendor', 'check:demos', 'check:react-barrel', 'check:react-types', 'check:text-runs', 'check:script-types', 'check:script-reach', 'check:focus-trap', 'check:pixel-parity', 'check:shared-arithmetic', 'check:packages', 'check:consumer', 'check:exports', 'check:classes', 'check:angular', 'check:angular-demos', 'check:assertions', 'check:cdk', 'check:boolean-inputs', 'check:optional-inputs'],
  );
});
