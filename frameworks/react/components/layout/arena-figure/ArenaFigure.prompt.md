A framed piece of media with an optional caption. The frame is a shape and a corner a voice
...
- **Do** let the frame crop. That is what `fit-media` is, and a voice that would rather letterbox
