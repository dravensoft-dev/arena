...
| `ArenaTag` | A pill for filters, technologies and statuses. Optional tone, optional dismiss. | `children` `tone` `removable` `disabled` `onRemove` | [`ArenaTag.prompt.md`](./arena-tag/ArenaTag.prompt.md) |
