...
| `ArenaTag` | A pill for filters, technologies and statuses. Optional tone, optional dismiss. | `content` `tone` `removable` `disabled` `remove` | [`ArenaTag.prompt.md`](./arena-tag/ArenaTag.prompt.md) |
...
13 display components in this layer.
