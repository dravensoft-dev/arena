...
hero, so `<arena-hero>` is the element you place. The hero's title takes the hero register, which is the top rung of the title ladder and the only one above a page head.
