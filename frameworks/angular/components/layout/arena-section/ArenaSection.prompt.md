...
- **Don't** open a second `<h2>` of your own inside the body. The section already opened one, and a
...
- With a screen reader running, the heading is announced as a level two and the section announces
